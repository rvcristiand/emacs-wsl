...
Snap needs to be [[https://snapcraft.io/docs/installing-snap-on-ubuntu][installed]] and then you can use the Emacs [[https://snapcraft.io/emacs][snap]]. Install it with:
...
@@html:<iframe src="https://snapcraft.io/emacs/embedded?button=black&channels=true" frameborder="0" width="100%" height="440px" style="border: 1px solid #CCC; border-radius: 2px;"></iframe>@@
